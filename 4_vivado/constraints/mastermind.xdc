...
# Pmod Header JD
set_property PACKAGE_PIN T14  [get_ports { guess[3] }];
set_property PACKAGE_PIN T15  [get_ports { guess[2] }];
set_property PACKAGE_PIN P14  [get_ports { guess[1] }];
set_property PACKAGE_PIN R14  [get_ports { guess[0] }];

set_property PACKAGE_PIN U14  [get_ports { guess[7] }];
set_property PACKAGE_PIN U15  [get_ports { guess[6] }];
set_property PACKAGE_PIN V17  [get_ports { guess[5] }];
set_property PACKAGE_PIN V18  [get_ports { guess[4] }];

# Pmod Header JE
set_property PACKAGE_PIN V12  [get_ports { guess[11] }];
set_property PACKAGE_PIN W16  [get_ports { guess[10] }];
set_property PACKAGE_PIN J15  [get_ports { guess[9] }];
set_property PACKAGE_PIN H15  [get_ports { guess[8] }];

set_property PACKAGE_PIN V13  [get_ports { guess[15] }];
set_property PACKAGE_PIN U17  [get_ports { guess[14] }];
set_property PACKAGE_PIN T17  [get_ports { guess[13] }];
set_property PACKAGE_PIN Y17  [get_ports { guess[12] }];
